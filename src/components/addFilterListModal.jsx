...
import { addFilterList, fetchFilterLists } from '../redux/actions/filterListActions';
import { fetchFilterTypes } from '../redux/actions/filterTypeAction';

const AddFilterListModal = ({ show, onClose }) => {
                ...
                <div className="modal-content">
                    <form onSubmit={handleSubmit}>
                        <div className="modal-header">
                            <h5 className="modal-title">Add Filter List</h5>
...
export default AddFilterListModal;
